...
export default function PortfolioYanYoun() {
  useEffect(() => {
    // Charger les scripts nécessaires
    const loadScripts = async () => {
      // ScrollReveal
      const sr = document.createElement('script');
      sr.src = '/portfolio-yan-youn/assets/js/scrollreveal.min.js';
      document.body.appendChild(sr);

      // Anime.js
      const anime = document.createElement('script');
      anime.src = 'https://cdn.jsdelivr.net/npm/animejs/lib/anime.iife.min.js';
      document.body.appendChild(anime);

      // Swiper
      const swiper = document.createElement('script');
      swiper.src = '/portfolio-yan-youn/assets/js/swiper-bundle.min.js';
      document.body.appendChild(swiper);

      // Main JS
      const main = document.createElement('script');
      main.src = '/portfolio-yan-youn/assets/js/main.js';
      ...
      if (contactBtn) {
        ...
        contactBtn.addEventListener('click', () => {
          if (email) {
            ...
            setTimeout(() => {
              contactBtn.innerHTML = 'Copy Email <i class="ri-file-copy-line"></i>';
            }, 2000);
          }
        });
      }
        ...
        <section className="home section section-top section-two">
          ...
          <div className="home__container container grid">
            ...
            <div className="home__image">
              <div className="blob-animate"></div>
              <img
                src="/portfolio-yan-youn/assets/img/hero-profile1.png"
                alt="Profile Picture"
            ...
            <a
              href="/portfolio-yan-youn/assets/pdf/Yan-Ur-Rehman-Resume.pdf"
              download
              target="_blank"
              className="home__cv"
            >
          ...
          <div className="about__container container grid">
            <div className="about__data">
              ...
              <p className="about__description">
                I'm a <b>Full Stack Developer</b> from Benin passionate about
                building <b>digital products</b> and <b>web solutions.</b> I work
                with Next.js, Node.js, React, TypeScript, and Django to create
                scalable applications for the African market.
              </p>
            ...
            <div className="about__image">
              ...
              <div className="blob-animate"></div>
              <img
                src="/portfolio-yan-youn/assets/img/home-perfil1.png"
                alt="Profile Picture"
              ...
              <div className="swiper-wrapper">
                ...
                <article className="projects__card swiper-slide">
                  ...
                  <div className="projects__data">
                    ...
                    <p className="projects__description">
                      Next.js 15, TypeScript, Tailwind CSS, Node.js, PostgreSQL
                    </p>
                  </div>
                  <div className="projects__image">
                    <img
                      src="/portfolio-yan-youn/assets/img/project-6.png"
                      alt="Project Image"
                      className="projects__img"
                    />
                    <a
                      href="https://prospyto.dev"
                      target="_blank"
                      rel="noopener noreferrer"
                ...
                <article className="projects__card swiper-slide">
                  ...
                  <div className="projects__data">
                    ...
                    <p className="projects__subtitle">Techstack used</p>
                    <p className="projects__description">
                      Next.js, React, Django REST, PostgreSQL, Cloudinary
                    </p>
                  </div>
                  <div className="projects__image">
                    <img
                      src="/portfolio-yan-youn/assets/img/project-1.png"
                      alt="Project Image"
                      className="projects__img"
                    />
                    <a
                ...
                <article className="projects__card swiper-slide">
                  ...
                  <div className="projects__data">
                    ...
                    <p className="projects__subtitle">Techstack used</p>
                    <p className="projects__description">
                      Next.js 15, TypeScript, Tailwind CSS v4, Animations
                    </p>
                  </div>
                  <div className="projects__image">
                    <img
                      src="/portfolio-yan-youn/assets/img/project-8.png"
                      alt="Project Image"
                      className="projects__img"
                    />
                    <a
